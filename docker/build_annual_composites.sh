#!/bin/bash
#
# Script to build ITS_LIVE docker image for the datacube annual composites.
#
echo '
=======================================================
Building datacube annual composites docker image...
======================================================='
...
TEMP_STAGING_DIR=$(mktemp -d staging_for_composite_docker_image_XXXXXXXXXX)
function cleanup {
...
cp -r ${WORKSPACE}/src/itscube_types.py ${WORKSPACE}/src/itscube.py \
      ...
      ${WORKSPACE}/src/itslive_binary_type.py \
      ${WORKSPACE}/src/utils.py ${WORKSPACE}/src/shapefile.py \
      ${WORKSPACE}/src/itslive_composite.py ${WORKSPACE}/src/aws_utils.py \
...
cp -r ${WORKSPACE}/environment/composite_environment.yml \
      ${WORKSPACE}/environment/aws_config \
      ${WORKSPACE}/docker/entrypoint_annual_composites.sh \
