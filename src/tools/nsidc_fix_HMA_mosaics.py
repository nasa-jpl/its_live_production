"""
Script to fix mapping attributes of V1 ITS_LIVE mosaics with EPGS code of 102027
...
class FixESRIMosaics:
    """
    Class to fix mapping attributes of V1 ITS_LIVE mosaics for ingest by NSIDC.
    ...
    def __call__(self, target_bucket: dir, target_dir: dir):
        """
        Fix ITS_LIVE mosaics's mapping data variable.
        """
