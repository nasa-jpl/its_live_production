...
It accepts JSON file that lists submitted jobs, as generated by run_batch.py,
and a file with job IDs that need to be re-run.

Example:
    python ./run_failed.py -j datacube_batch_rerun_3413_July26.json -f failed_3413_jobs_July26.txt -o datacube_batch_rerun_3413_July27.json
