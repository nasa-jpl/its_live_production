...
ENCODING = {
    ...
    'vx_error':                  {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vy_error':                  {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'v_error':                   {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vx_amp_error':              {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vy_amp_error':              {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'v_amp_error':               {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vx_amp':                    {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vy_amp':                    {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'v_amp':                     {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vx_phase':                  {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vy_phase':                  {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'v_phase':                   {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'dt_max':                    {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vx0_error':                 {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
    'vy0_error':                 {'_FillValue': 0, 'dtype': np.uint16, "zlib": True, "complevel": 2, "shuffle": True},
