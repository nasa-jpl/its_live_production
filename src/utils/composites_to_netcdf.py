...
ENCODING = {
    ...
    'sensor_filter_applied':      {'_FillValue': 0, 'dtype': np.uint8, "zlib": True, "complevel": 2, "shuffle": True},
    'landice':                   {'_FillValue': 0, 'dtype': np.uint8, "zlib": True, "complevel": 2, "shuffle": True},
    'floatingice':                {'_FillValue': 0, 'dtype': np.uint8, "zlib": True, "complevel": 2, "shuffle": True},
