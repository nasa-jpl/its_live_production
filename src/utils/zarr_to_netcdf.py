...
ENCODING_ZARR = {
    ...
    'stable_shift_flag':         {'_FillValue': None, 'dtype': 'long'},
    ...
    'v_error':                   {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'v':                         {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'vx':                        {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'vx_error':                  {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vx_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy':                        {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'vy_error':                  {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vy_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va':                        {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'va_error':                  {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'va_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr':                        {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'vr_error':                  {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'vr_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'M11_dr_to_vr_factor':       {'_FillValue': 0.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'M12_dr_to_vr_factor':       {'_FillValue': 0.0, 'dtype': 'float', 'compressor': COMPRESSION_ZARR},
    'M11':                       {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
    'M12':                       {'_FillValue': -32767, 'dtype': 'short', 'compressor': COMPRESSION_ZARR},
...
ENCODING = {
    ...
    'vx_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vx_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vx_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vx_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vx_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vx_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    ...
    'vy_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vy_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vy_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vy_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vy_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vy_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va':                        {'_FillValue': -32767, 'dtype': 'short', "zlib": True, "complevel": 2, "shuffle": True},
    'va_error':                  {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'va_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr':                        {'_FillValue': -32767, 'dtype': 'short', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_error':                  {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_error_mask':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_error_modeled':          {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_error_slow':             {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_stable_shift':           {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_stable_shift_slow':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'vr_stable_shift_mask':      {'_FillValue': -32767.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'M11_dr_to_vr_factor':       {'_FillValue': 0.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
    'M12_dr_to_vr_factor':       {'_FillValue': 0.0, 'dtype': 'float', "zlib": True, "complevel": 2, "shuffle": True},
